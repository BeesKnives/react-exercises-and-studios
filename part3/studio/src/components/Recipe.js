...
const RecipeAuthor = () => {
   ...
   return (
      <div>
         <img src={authorPhoto} alt = "" style={{objectFit: "contain", borderRadius: "50%"}} height="250" />
         <div>
            <h3>{authorName}</h3>
            <a href={authorLink}></a> 
         </div>
...
const RecipePhoto = () => {
   return (
      <img src="https://thecozycook.com/wp-content/uploads/2021/10/Stovetop-Mac-and-Cheese-2.jpg" alt="Mac and Cheese" className="imageUpdates" height="250"/>
   );
}
